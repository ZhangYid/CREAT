...
def get_edge_mask_dict(ghetero):
    ...
    for etype in ghetero.canonical_etypes:
        ...
        if num_nodes==0:
            num_nodes=0.001
        std = torch.nn.init.calculate_gain('relu') * np.sqrt(2.0 / (2 * num_nodes+1))
...
class PaGELink(nn.Module):
    ...
    def _prune_graph(self, ghetero, prune_max_degree=-1, k_core=8, always_preserve=[]):
    ...
    def explain(self,  
        ...
        #  comp_g, 
        #  comp_g_feat_nids,
        #  comp_g_feat_eids) = hetero_src_tgt_khop_in_subgraph(self.src_ntype, 
        #                                                      src_nid, 
        #                                                      self.tgt_ntype, 
        #                                                      tgt_nid, 
        #                                                      ghetero, 
