...
processed_g = load_dataset(args.dataset_dir, args.dataset_name, args.pred_etype, args.valid_ratio, args.test_ratio)[1]
...
if args.save_model:
    ...
    output_dir = '/home/lab/zyd/CREAT/code/saved_models/'
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
    # torch.save(model.state_dict(), output_dir.joinpath(f"{args.dataset_name}_model.pth"))
    torch.save(model.state_dict(), output_dir+f"{args.dataset_name}_model.pth")
